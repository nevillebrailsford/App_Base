...
public class ColorProvider {
	private static String[] name = new String[] { "aliceblue", "antiquewhite", "aqua", "aquamarine", "azure", "beige",
	...
	private static String[] hex = new String[] { "#f0f8ff", "#faebd7", "#00ffff", "#7fffd4", "#f0ffff", "#f5f5dc",
			...
			"#8fbc8f", "#8fbc8f", "#483d8b", "#2f4f4f", "#00ced1", "#9400d3", "#ff1493", "#00bfff", "#696969",
			"#1e90ff", "#b22222", "#fffaf0", "#228b22", "#ff00ff", "#dcdcdc", "#f8f8ff", "#ffd700", "#daa520",
			"#808080", "#adff2f", "#f0fff0", "#ff69b4", "#cd5c5c", "#4b0082", "#fffff0", "#f0e68c", "#e6e6fa",
			"#fff0f5", "#7cfc00", "#fffacd", "#add8e6", "#f08080", "#e0ffff", "#fafad2", "#d3d3d3", "#90ee90",
			"#ffb6c1", "#ffa07a", "#ffa07a", "#87cefa", "#778899", "#b0c4de", "#ffffe0", "#00ff00", "#32cd32",
